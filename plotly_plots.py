...
#%%
def plot_performance(result_df):
    fig = make_subplots(
        rows=2, cols=1, 
        shared_xaxes=True, 
        vertical_spacing=0.05,
        row_heights=[0.7, 0.3],
        subplot_titles=("Strategy vs Buy & Hold", "Price & Trades")
    )
    
    # 1. Cumulatieve groei grafiek
    fig.add_trace(
    ...
    # Koopmomenten markeren (waar position van 0 naar 1 gaat)
    ...
    # Verkoopmomenten markeren (waar position van 1 naar 0 gaat)
