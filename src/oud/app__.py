...
"""
CLAUDE VRAGEN:
app.py is nu heel erg goed! wil toch nog een paar dingetjes aangepast hebben:

* Bij invullen indicators als ik wat invul en ENTER doe dan sprint soms toch de oude waarde terug, de tweede keer dat ik het doe gaat het wel goed. Deze bug moet opgelost worden.
* Ik wil een csv of excel kunnen importeren (bestand kiezen vanuit map op computer). Dus een bestand met datum in index, en kolommen open, high, low, close. dit moet werken. Geef info bij import, zodat gebruiker goed weet wat eisen zijn om het te laten werken. Vul mijn instructie aan indien nodig/handig
* De functie opslaan van csv werkt goed, ik wil OOK de optie hebben om alle resultaten op te slaan als html of als pdf
"""
