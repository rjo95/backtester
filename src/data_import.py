...
df_btc['SMA_50'] = ta.sma(df_btc['close'], length=50)
df_btc['SMA_100'] = ta.sma(df_btc['close'], length=100)
df_btc['SMA_200'] = ta.sma(df_btc['close'], length=200)
df_btc['RSI_14'] = ta.rsi(df_btc['close'], length=14)
